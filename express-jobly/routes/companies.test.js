...
describe('GET /companies', function () {
	...
	test('should get by query name', async function () {
	...
	test('should get by query min-employees', async function () {
		const resp = await request(app)
			.get('/companies')
	...
	test('should get by query max-employees', async function () {
		const resp = await request(app)
			.get('/companies')
